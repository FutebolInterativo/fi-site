...
export default function CursosClient() {
  ...
  const filtrados = cursos.filter((c) => {
    ...
    const matchBusca = c.title.toLowerCase().includes(busca.toLowerCase());
          ...
          <div style={{ maxWidth: 480, margin: "0 auto" }}>
            <input
              ...
              style={{
                ...
                padding: "14px 16px",
                borderRadius: 12,
                border: "1px solid rgba(140,200,245,0.2)",
                background: "rgba(12,152,252,0.06)",
                color: "#F4F4F4",
                fontFamily: M,
                fontSize: 14,
                outline: "none",
            ...
            return (
              <button
                ...
                style={{
                  ...
                  padding: "8px 18px",
                  borderRadius: 40,
                  border: `1px solid ${ativo ? a.color : "rgba(140,200,245,0.2)"}`,
                  whiteSpace: "nowrap",
                  cursor: "pointer",
                  flexShrink: 0,
                  background: ativo ? `${a.color}22` : "transparent",
                  color: ativo ? a.color : "rgba(244,244,244,0.65)",
                  transition: "all 0.2s",
                }}
              >
                {a.label}
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
            {filtrados.map((c) => (
              <CursoCard
                ...
                type={c.type}
                area={c.area}
                areaLabel={areas.find((a) => a.id === c.area)?.label || c.area}
