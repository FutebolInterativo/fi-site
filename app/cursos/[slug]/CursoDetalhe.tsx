...
function SectionLight({ eyebrow, title, children }: { eyebrow?: string; title: string; children: React.ReactNode }) {
  return React.createElement(
    ...
    React.createElement(
      ...
      eyebrow && React.createElement("p", { style: { fontFamily: M, fontWeight: 700, fontSize: "clamp(11px,2.4vw,14px)", letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "#2E6CA8", marginBottom: 12 } }, eyebrow),
      React.createElement("h2", { style: { fontFamily: F, fontWeight: 400, fontSize: "clamp(28px,6vw,52px)", lineHeight: 0.95, letterSpacing: "0.01em", color: "#103B66", marginBottom: "clamp(24px,4vh,44px)" } }, title),
      children
    )
  );
}
...
function SectionBlue({ eyebrow, title, children }: { eyebrow?: string; title: string; children: React.ReactNode }) {
  return React.createElement(
    ...
    React.createElement(
      "div",
      { style: { maxWidth: 1040, margin: "0 auto" } },
      eyebrow && React.createElement("p", { style: { fontFamily: M, fontWeight: 700, fontSize: "clamp(11px,2.4vw,14px)", letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "rgba(169,216,245,0.9)", marginBottom: 12 } }, eyebrow),
      React.createElement("h2", { style: { fontFamily: F, fontWeight: 400, fontSize: "clamp(28px,6vw,52px)", lineHeight: 0.95, letterSpacing: "0.01em", color: "#fff", marginBottom: "clamp(24px,4vh,44px)" } }, title),
      children
    )
  );
}
...
function SectionDark({ eyebrow, title, children }: { eyebrow?: string; title: string; children: React.ReactNode }) {
  return React.createElement(
    ...
    React.createElement(
      "div",
      { style: { maxWidth: 1040, margin: "0 auto" } },
      eyebrow && React.createElement("p", { style: { fontFamily: M, fontWeight: 700, fontSize: "clamp(11px,2.4vw,14px)", letterSpacing: "0.18em", textTransform: "uppercase" as const, color: "#A9D8F5", marginBottom: 12 } }, eyebrow),
      React.createElement("h2", { style: { fontFamily: F, fontWeight: 400, fontSize: "clamp(28px,6vw,52px)", lineHeight: 0.95, letterSpacing: "0.01em", color: "#fff", marginBottom: "clamp(24px,4vh,44px)" } }, title),
      children
    )
  );
...
function CheckItem({ text, cor, light }: { text: string; cor: string; light?: boolean }) {
  return React.createElement(
    "li",
    { style: { display: "flex", alignItems: "flex-start", gap: 10, fontFamily: M, fontWeight: 500, fontSize: "clamp(13px,1.6vw,15px)", lineHeight: 1.45, color: light ? "rgba(255,255,255,0.9)" : "#1B3F63" } },
...
export default function CursoDetalhe({ curso }: { curso: Curso }) {
  ...
  const hero = React.createElement(
    "section",
    { style: { background: "linear-gradient(160deg,#021829 0%,#03263F 55%,#052e4d 100%)", padding: "120px clamp(20px,5vw,64px) clamp(48px,8vh,80px)" } },
    React.createElement(
      "div",
      { style: { maxWidth: 1040, margin: "0 auto" } },
      ...
      React.createElement(
        ...
        React.createElement(
          "span",
          { style: { fontFamily: M, fontWeight: 700, fontSize: 11, letterSpacing: "0.12em", textTransform: "uppercase" as const, color: cor, background: `${cor}20`, padding: "5px 14px", borderRadius: 20, border: `1px solid ${cor}40` } },
        ...
        React.createElement(
          "span",
          { style: { fontFamily: M, fontWeight: 700, fontSize: 11, letterSpacing: "0.08em", textTransform: "uppercase" as const, color: "rgba(244,244,244,0.45)", background: "rgba(255,255,255,0.06)", padding: "5px 14px", borderRadius: 20 } },
          curso.type
        )
      ),

      // título
      React.createElement("h1", { style: { fontFamily: F, fontWeight: 400, fontSize: "clamp(38px,5.5vw,72px)", lineHeight: 0.93, letterSpacing: "0.01em", color: "#F4F4F4", marginBottom: 20 } }, curso.title),

      // subheadline
      curso.subheadline && React.createElement("p", { style: { fontFamily: M, fontWeight: 500, fontSize: "clamp(15px,1.6vw,18px)", lineHeight: 1.6, color: "rgba(244,244,244,0.75)", maxWidth: 640, marginBottom: 28 } }, curso.subheadline),
      ...
      (curso.cargaHoraria || curso.numAulas || curso.formato) && React.createElement(
        ...
        ...[
          curso.cargaHoraria ? { num: curso.cargaHoraria, label: "Carga horária" } : null,
          curso.numAulas     ? { num: String(curso.numAulas), label: "Aulas" }     : null,
          curso.formato      ? { num: curso.formato, label: "Formato" }            : null,
        ].filter(Boolean).map((s, i, arr) =>
          React.createElement(
            "div",
            { key: s!.label, style: { paddingRight: 24, marginRight: 24, borderRight: i < arr.length - 1 ? "1px solid rgba(140,200,245,0.2)" : "none" } },
      ...
      curso.headline && React.createElement("p", { style: { fontFamily: M, fontWeight: 500, fontSize: 15, lineHeight: 1.7, color: "rgba(244,244,244,0.65)", maxWidth: 580 } }, curso.headline)
    )
  );
  ...
  const paraQuem = curso.paraQuem && curso.paraQuem.length > 0 && SectionLight({
    ...
    children: React.createElement(
      ...
      ...curso.paraQuem.map((item, i) => React.createElement(CheckItem, { key: i, text: item, cor }))
    ),
  });

  // ── EMENTA ────────────────────────────────────────────────────────────────
  // FIX: item.titulo (não item direto — EmentaItem não é ReactNode)
  const ementa = curso.ementa && curso.ementa.length > 0 && SectionBlue({
    ...
    children: React.createElement(
      ...
      ...curso.ementa.map((item, i) =>
        React.createElement(
          "div",
          { key: i, style: { display: "flex", alignItems: "flex-start", gap: 12, background: "rgba(255,255,255,0.07)", borderRadius: 14, padding: "14px 18px", border: "1px solid rgba(255,255,255,0.1)" } },
          React.createElement("span", { style: { fontFamily: F, fontSize: 13, color: "rgba(169,216,245,0.6)", flexShrink: 0, width: 28, lineHeight: 1.2 } }, String(i + 1).padStart(2, "0")),
          React.createElement(
            "div",
            null,
            // FIX: item.titulo em vez de item
            React.createElement("span", { style: { fontFamily: M, fontWeight: 600, fontSize: 14, lineHeight: 1.4, color: "rgba(255,255,255,0.95)", display: "block" } }, item.titulo),
            // item.descricao opcional
            item.descricao && React.createElement("span", { style: { fontFamily: M, fontWeight: 400, fontSize: 12, lineHeight: 1.45, color: "rgba(169,216,245,0.65)", display: "block", marginTop: 4 } }, item.descricao)
          )
        )
      )
    ),
  ...
  // ── MENTORES ──────────────────────────────────────────────────────────────
  // FIX: removido m.cargo (não existe no tipo Mentor — só nome, bio, foto)
  const mentores = curso.mentores && curso.mentores.length > 0 && SectionLight({
    eyebrow: "Quem vai te ensinar",
    title: "OS MENTORES",
    children: React.createElement(
      "div",
      { style: { display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(160px, 1fr))", gap: "clamp(16px,3vw,28px)" } },
      ...curso.mentores.map((m, i) =>
        React.createElement(
          "div",
          { key: i, style: { display: "flex", flexDirection: "column" as const, gap: 10 } },
          m.foto && React.createElement(
            "div",
            { style: { borderRadius: 18, overflow: "hidden", background: "#d8e8f4", aspectRatio: "3/4" } },
            React.createElement("img", { src: m.foto, alt: m.nome, style: { width: "100%", height: "100%", objectFit: "cover", objectPosition: "top center", display: "block" } })
          ),
          React.createElement("div", { style: { fontFamily: F, fontSize: "clamp(16px,2vw,22px)", lineHeight: 1, color: "#103B66" } }, m.nome),
          // FIX: m.bio (não m.cargo)
          m.bio && React.createElement("div", { style: { fontFamily: M, fontWeight: 500, fontSize: 12, lineHeight: 1.5, color: "#3F5F7C" } }, m.bio)
        )
      )
    ),
  });
  ...
  const diferenciais = curso.diferenciais && curso.diferenciais.length > 0 && SectionDark({
    ...
    children: React.createElement(
      ...
      ...curso.diferenciais.map((d, i) =>
        React.createElement(
          "li",
          { key: i, style: { display: "flex", alignItems: "flex-start", gap: 10, fontFamily: M, fontWeight: 500, fontSize: 14, lineHeight: 1.45, color: "rgba(255,255,255,0.88)", background: "rgba(12,152,252,0.08)", borderRadius: 14, padding: "14px 16px", border: "1px solid rgba(140,200,245,0.15)" } },
  ...
  const expPratica = curso.experienciaPratica && curso.experienciaPratica.length > 0 && SectionBlue({
    ...
    children: React.createElement(
      ...
      ...curso.experienciaPratica.map((item, i) => React.createElement(CheckItem, { key: i, text: item, cor: "#4ADBF8", light: true }))
    ),
  });

  // ── DEPOIMENTOS ───────────────────────────────────────────────────────────
  // FIX: d.videoUrl (não d.youtubeId) — extrair ID com ytId()
  const depoimentos = curso.depoimentos && curso.depoimentos.length > 0 && React.createElement(
    ...
    React.createElement(
      ...
      React.createElement(
        "div",
        { style: { display: "grid", gridTemplateColumns: `repeat(${Math.min(curso.depoimentos.length, 3)}, 1fr)`, gap: "clamp(20px,3vw,36px)" } },
        ...curso.depoimentos.map((d, i) => {
          const vid = d.videoUrl ? ytId(d.videoUrl) : "";
          return React.createElement(
            "div",
            { key: i, style: { display: "flex", flexDirection: "column" as const } },
            vid && React.createElement(
              "div",
              { style: { borderRadius: 18, overflow: "hidden", background: "#07101c", aspectRatio: "16/9", marginBottom: 16 } },
            ...
            React.createElement("div", { style: { fontFamily: F, fontWeight: 400, fontSize: "clamp(18px,2.4vw,26px)", lineHeight: 1, color: "#103B66", marginBottom: 6 } }, d.nome),
            d.papel && React.createElement("div", { style: { fontFamily: M, fontWeight: 700, fontSize: 11, letterSpacing: "0.08em", textTransform: "uppercase" as const, color: cor, marginBottom: 8 } }, d.papel),
    ...
    React.createElement(
      ...
      ...curso.stats.map((s, i) =>
        React.createElement(
          ...
          // FIX: s.valor (não s.num)
          React.createElement("div", { style: { fontFamily: F, fontSize: "clamp(40px,7vw,72px)", lineHeight: 0.9, color: "#8FCBEF", letterSpacing: "0.01em" } }, s.valor),
  ...
  const garantia = curso.garantiaTexto && React.createElement(
    ...
    React.createElement(
      "div",
      { style: { maxWidth: 860, margin: "0 auto", background: "#E9F2FB", borderRadius: 28, padding: "clamp(28px,5vw,48px) clamp(24px,4vw,56px)", display: "flex", flexWrap: "wrap" as const, alignItems: "center", gap: "clamp(20px,3vw,36px)" } },
      React.createElement(
        "div",
        { style: { width: "clamp(80px,16vw,110px)", height: "clamp(80px,16vw,110px)", flexShrink: 0, borderRadius: "50%", background: "#BFE0F5", display: "flex", alignItems: "center", justifyContent: "center" } },
        React.createElement(
          "svg",
