        ...
        >
          ...
          <div className="relative flex flex-col md:flex-row md:items-center md:justify-between gap-8">
            ...
            <div className="flex flex-col gap-3 md:flex-shrink-0 md:w-auto w-full">
              <button
                onClick={openModal}
                onMouseEnter={() => loadHubspotScript()}
                onTouchStart={() => loadHubspotScript()}
                style={{ fontFamily: M, fontWeight: 700, fontSize: 14, color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", gap: 8, padding: "14px 24px", borderRadius: 12, background: "#25d366", boxShadow: "0 8px 22px rgba(37,211,102,0.35)", border: "none", cursor: "pointer" }}
              >
