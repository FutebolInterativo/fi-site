...
const passos = [
  {
    num: "01",
    titulo: "APRENDA ONLINE",
    desc: "Aulas com profissionais que atuam no mercado. Conteúdo direto, sem enrolação. Assista no seu ritmo.",
    icon: (
  ...
  {
    num: "02",
    titulo: "VIVA DENTRO DE UM CLUBE",
    desc: "A experiência prática é garantida. Você entra em um dos +130 clubes parceiros e coloca o currículo pra correr.",
    icon: (
      <svg width={20} height={20} viewBox="0 0 24 24" fill="none">
  ...
  },
  {
    ...
    desc: "Você desenvolve o repertório técnico e comportamental que os clubes exigem — teoria aplicada, sem enrolação, pra chegar preparado no primeiro dia.",
    icon: (
      <svg width={20} height={20} viewBox="0 0 24 24" fill="none">
        ...
        <FadeIn>
          <div style={{ marginBottom: 56, maxWidth: 620 }}>
            ...
            <p style={{ fontFamily: M, fontSize: 15, fontWeight: 500, color: "rgba(244,244,244,0.55)", lineHeight: 1.65 }}>
              Nossa metodologia foi construída para quem quer resultados reais.
            </p>
          </div>
        </FadeIn>
