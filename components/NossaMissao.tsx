  ...
  return (
    <div style={{ width: "100%", maxWidth: 420, margin: "0 auto" }}>
      <div style={{ height: 6, borderRadius: 99, background: "rgba(255,255,255,0.08)", overflow: "hidden" }}>
        <div ref={ref} style={{ width: "0%", height: "100%", borderRadius: 99, background: "linear-gradient(90deg,#0C98FC,#4FC3FF)", transition: "width 1.4s cubic-bezier(.22,.61,.36,1)" }} />
      </div>
      <div style={{ display: "flex", justifyContent: "space-between", marginTop: 10, fontFamily: M, fontSize: 11, fontWeight: 700, color: "rgba(169,216,245,0.5)", letterSpacing: "0.04em" }}>
  ...
  return (
    <section style={{ background: "linear-gradient(180deg,#010E1B 0%,#03263F 55%,#010E1B 100%)", padding: "clamp(80px,11vh,120px) 0", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ maxWidth: 780, margin: "0 auto", padding: "0 clamp(22px,5vw,64px)", textAlign: "center" as const, position: "relative" }}>
        ...
        <FadeIn>
          {/* trave de gol — ícone decorativo, reforça o tema sem foto */}
          ...
          {/* "por quê" — o propósito por trás da missão, direto do planejamento estratégico */}
          <p style={{ fontFamily: M, fontSize: 12.5, fontWeight: 600, color: "rgba(169,216,245,0.55)", letterSpacing: "0.01em", marginBottom: 18 }}>
          ...
          <h2 style={{ fontFamily: F, fontSize: "clamp(26px,4.4vw,46px)", lineHeight: 1.15, color: "#F4F4F4", marginBottom: 44, fontWeight: 400 }}>
            Guiar a nova geração de profissionais<br />
            do futebol brasileiro <span style={{ color: "#0C98FC" }}>à excelência.</span>
          </h2>
        </FadeIn>
