...
export default function CursoCTA({ curso, cor = "#4096F2" }: { curso: Curso; cor?: string }) {
  ...
  return (
    <div
      className="rounded-3xl border overflow-hidden shadow-[0_30px_60px_-20px_rgba(0,0,0,0.6)] flex flex-col justify-between bg-gradient-to-b from-[#0F2744] to-[#0A1E35]"
