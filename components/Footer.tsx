...
/*
  ATENÇÃO: alterado pra tema claro/branco conforme pedido no doc de alterações.
  O logo atual (logo.png) provavelmente é a versão branca feita pra fundo escuro
  — pode ficar ilegível aqui. Substituir por uma versão navy/escura do logo,
  ou remover o filter abaixo se já tiver a versão correta.
*/
    ...
    <footer style={{ background:"#FFFFFF", borderTop:"1px solid rgba(3,38,63,0.1)" }}>
      <div className="max-w-6xl mx-auto px-6" style={{ paddingTop:48, paddingBottom:32 }}>
        <div className="grid md:grid-cols-4 gap-10" style={{ marginBottom:48 }}>
          <div>
            <Image
              src="https://futebolinterativo.com/novo-site/img/logo.png"
              alt="Futebol Interativo"
              width={140}
              height={36}
              style={{ height:32, width:"auto", marginBottom:16, filter:"invert(1) brightness(0.2)" }}
            />
