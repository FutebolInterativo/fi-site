...
const depos = [
  { foto:"/images/site/mantovani.jpeg", name:"RAFAEL MANTOVANI", role:"Contratado pelo Ituano", quote:"A experiência prática no Ituano foi o que abriu as portas. Entrei no clube, mostrei meu trabalho e fui contratado. O FI entregou exatamente o que prometeu." },
  { foto:"/images/site/Hoffmann.jpeg", name:"OTAVIO HOFFMANN", role:"Analista — Atlético-MG", quote:"Fiz a prática no Bahia. Hoje sou Analista de Desempenho do Atlético-MG. O FI me deu o conteúdo e o caminho para chegar lá." },
  { foto:"/images/site/Victoria.jpeg", name:"VICTORIA SOUZA", role:"Contratada pelo Botafogo", quote:"Realizei minha prática no Bahia e fui contratada pelo Botafogo. O FI é a ponte entre quem você é e quem o futebol precisa." },
];
          ...
          {depos.map((d) => (
            <div key={d.name} className="flex flex-col gap-4 p-6 rounded-2xl" style={{ border:"1px solid rgba(140,200,245,0.14)", background:"linear-gradient(145deg,rgba(12,90,150,0.25),rgba(3,38,63,0.4))" }}>
              ...
              <div style={{ display:"flex", alignItems:"center", gap:12 }}>
                ...
                <img src={d.foto} alt={d.name} style={{ width:40, height:40, borderRadius:"50%", objectFit:"cover", flexShrink:0, border:"1.5px solid rgba(140,200,245,0.3)" }} />
                <div>
