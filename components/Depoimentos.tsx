      ...
      <div className="max-w-6xl mx-auto px-6">
        <FadeIn>
          <div style={{ marginBottom: 36 }}>
            ...
            <p style={{ fontFamily: M, fontSize: "clamp(17px,1.7vw,19px)", fontWeight: 500, color: "rgba(244,244,244,0.72)", lineHeight: 1.6, maxWidth: 560 }}>
          ...
          {depos.map((d, i) => (
            <FadeIn key={d.name} delay={i * 100}>
              ...
              >
                ...
                <p style={{
                  fontFamily: M, fontSize: 15.5, fontWeight: 500, color: "rgba(244,244,244,0.8)", lineHeight: 1.55, flex: 1, marginBottom: 18, position: "relative",
                }}>
                  &ldquo;{d.quote}&rdquo;
                </p>
