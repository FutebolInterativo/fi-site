...
type Clube = { nome: string; cidade: string; logo: string };
type Estado = { label: string; clubes: Clube[] };

const ESTADOS: Record<string, Estado> = {
  ba: { label: "Bahia", clubes: [
    { nome: "Vitória", cidade: "Salvador, Bahia", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fvit%C3%B3ria.png" },
    { nome: "Jacuipense", cidade: "Salvador, Bahia", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fjacuipense.png" },
    { nome: "Juazeirense", cidade: "Juazeiro, Bahia", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FJuazeirense.png" },
    { nome: "SSA FC", cidade: "Salvador, Bahia", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FSSA%20FC.png" },
    { nome: "Catuense", cidade: "Alagoinhas, Bahia", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FCatuense.png" },
  ]},
  se: { label: "Sergipe", clubes: [
  ...
  pe: { label: "Pernambuco", clubes: [
    ...
    { nome: "SE Ypiranga", cidade: "Santa Cruz do Capibaribe, Pernambuco", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FSEYFC.png" },
  ]},
  al: { label: "Alagoas", clubes: [
  ...
  am: { label: "Amazonas", clubes: [
    ...
    { nome: "Manaus", cidade: "Manaus, Amazonas", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fmanaus.png" },
  ]},
  pa: { label: "Pará", clubes: [
    { nome: "Paysandu", cidade: "Belém, Pará", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fpaysandu.png" },
    { nome: "Remo", cidade: "Belém, Pará", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fremo.png" },
    { nome: "Tuna Luso", cidade: "Belém, Pará", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FTunaLuso.png" },
  ]},
  mt: { label: "Mato Grosso", clubes: [
    { nome: "Luverdense", cidade: "Lucas do Rio Verde, Mato Grosso", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Flec.png" },
    { nome: "Primavera", cidade: "Primavera do Leste, Mato Grosso", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fprimaveral.png" },
  ]},
  ro: { label: "Rondônia", clubes: [
    { nome: "Ji-Paraná", cidade: "Ji-Paraná, Rondônia", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FJi%20parana.png" },
    { nome: "Genus", cidade: "Porto Velho, Rondônia", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FGENUS.png" },
  ]},
  rj: { label: "Rio de Janeiro", clubes: [
    { nome: "Volta Redonda", cidade: "Volta Redonda, Rio de Janeiro", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FvoltaR.png" },
    { nome: "Portuguesa-RJ", cidade: "Ilha do Governador, Rio de Janeiro", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fportuguesarj.png" },
    { nome: "Serrano", cidade: "Rio de Janeiro, Rio de Janeiro", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FSerrano.png" },
    { nome: "Madureira", cidade: "Rio de Janeiro, Rio de Janeiro", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FMadureira.png" },
  ...
  rs: { label: "Rio Grande do Sul", clubes: [
    ...
    { nome: "SER Caxias", cidade: "Caxias do Sul, Rio Grande do Sul", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FCRS.png" },
    { nome: "São Luiz de Ijuí", cidade: "Ijuí, Rio Grande do Sul", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fsjijui.png" },
    { nome: "Monsoon", cidade: "Porto Alegre, Rio Grande do Sul", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fmon.png" },
    { nome: "Lajeado", cidade: "Lajeado, Rio Grande do Sul", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Flajeado.png" },
    { nome: "Avenida", cidade: "Santa Cruz do Sul, Rio Grande do Sul", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FAVENIDA.png" },
    { nome: "Pelotas", cidade: "Pelotas, Rio Grande do Sul", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FPELOTAS-rs.png" },
  ...
  sc: { label: "Santa Catarina", clubes: [
    ...
    { nome: "Figueirense", cidade: "Florianópolis, Santa Catarina", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Ffigueirense.png" },
    { nome: "Marcílio Dias", cidade: "Itajaí, Santa Catarina", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FmarcilioD.png" },
    { nome: "G.E. Juventus", cidade: "Jaraguá do Sul, Santa Catarina", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FJuventusSC.png" },
    { nome: "Manchester Catarinense", cidade: "Joinville, Santa Catarina", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FManchester.png" },
  ...
  pr: { label: "Paraná", clubes: [
    ...
    { nome: "Cascavel", cidade: "Cascavel, Paraná", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fcascavel.png" },
    { nome: "Toledo", cidade: "Toledo, Paraná", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FToledoEC%20(1).png" },
    { nome: "PSTC", cidade: "Londrina, Paraná", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fpstc.png" },
    { nome: "Operário", cidade: "Ponta Grossa, Paraná", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Foperario.png" },
    { nome: "Azuriz", cidade: "Pato branco, Paraná", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FAzuris.png" },
    { nome: "Galo Maringá", cidade: "Maringá, Paraná", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FGM.png" },
    { nome: "NB Futebol", cidade: "Curitiba, Paraná", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FNB%20Futebol.png" },
    { nome: "São Joseense", cidade: "São José dos Pinhais, Paraná", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fs%C3%A3o%20joseense.png" },
    { nome: "Hope internacional", cidade: "Campo Largo, Paraná", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FHOPE.png" },
  ]},
  sp: { label: "São Paulo", clubes: [
    { nome: "Ituano", cidade: "Itu, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fituano.png" },
    { nome: "Portuguesa", cidade: "São Paulo, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fportuguesa.png" },
    { nome: "XV de Piracicaba", cidade: "Piracicaba, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fxv.png" },
    { nome: "Salto", cidade: "Salto, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fsalto.png" },
    { nome: "Flamengo Guarulhos", cidade: "Guarulhos, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Ffguarulhos.png" },
    { nome: "Real Soccer", cidade: "Boituva, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Frs.png" },
    { nome: "Santo André", cidade: "Santo André, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fecsa.png" },
    { nome: "Santa Fé", cidade: "Santa Fé do Sul, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fsffc.png" },
    { nome: "AD Guarulhos", cidade: "Guarulhos, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FAD%20Guarulhos%20(2).png" },
    { nome: "Rio Branco", cidade: "Americana, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Frbsp.png" },
    { nome: "DS Sports", cidade: "Atibaia, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FSDSports.png" },
    { nome: "União Suzano", cidade: "Suzano, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fsuzano.png" },
    { nome: "Nacional", cidade: "São Paulo, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FNacional%20(3).png" },
    { nome: "Audax", cidade: "Osasco, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FAudax.png" },
    { nome: "Oeste", cidade: "Barueri, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FOeste.png" },
    { nome: "CATS", cidade: "Taboão da Serra, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FCATS.png" },
    { nome: "SKA Brasil", cidade: "Santana de Parnaíba, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FSKA.png" },
    { nome: "I9", cidade: "Ribeirão Preto, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FI9.png" },
    { nome: "Itapirense", cidade: "Itapira, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fitapirense.png" },
    { nome: "Itaquá", cidade: "Itaquaquecetuba, São Paulo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FItaqu%C3%A1.png" },
  ...
  go: { label: "Goiás", clubes: [
    ...
    { nome: "Vila Nova", cidade: "Goiânia, Goiás", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FVNFC.png" },
  ...
  mg: { label: "Minas Gerais", clubes: [
    ...
    { nome: "Coimbra", cidade: "Contagem, Minas Gerais", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fcoimbra.png" },
    { nome: "Uberlândia", cidade: "Uberlândia, Minas Gerais", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fuber.png" },
    { nome: "Itabirito", cidade: "Itabirito, Minas Gerais", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FItaFC.png" },
    { nome: "Betim", cidade: "Betim, Minas Gerais", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FBetim.png" },
    { nome: "Aymorés", cidade: "Ubá, Minas Gerais", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FAymor%C3%A9s.png" },
    { nome: "North", cidade: "Montes Claros, Minas Gerais", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FNorth.png" },
  ...
  es: { label: "Espírito Santo", clubes: [
    ...
    { nome: "Desportiva", cidade: "Cariacica, Espírito Santo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fdesportiva.png" },
    { nome: "Rio Branco", cidade: "Venda Nova do Imigrante, Espírito Santo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FRio%20Branco%20Futebol%20Clube.png" },
    { nome: "Serra", cidade: "Serra, Espírito Santo", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FSerra.png" },
  ]},
  pi: { label: "Piauí", clubes: [
    { nome: "Parnahyba", cidade: "Parnaíba, Piauí", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FParnahyba.png" },
    { nome: "TJD-PI", cidade: "Teresina, Piauí", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FTJD%20(1).png" },
  ]},
  ce: { label: "Ceará", clubes: [
    { nome: "CEFAT", cidade: "Fortaleza, Ceará", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fcefat.png" },
    { nome: "Ferroviário", cidade: "Fortaleza, Ceará", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fferroviario.png" },
    { nome: "Floresta", cidade: "Fortaleza, Ceará", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Ffloresta-1.png" },
    { nome: "Atlético Cearense", cidade: "Fortaleza, Ceará", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FAtl%C3%A9ticoCE.png" },
    { nome: "Tiradentes", cidade: "Fortaleza, Ceará", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FAE%20Tiradentes.png" },
  ]},
  ma: { label: "Maranhão", clubes: [
    { nome: "IAPE FC", cidade: "São Luís, Maranhão", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FIAPE.png" },
  ]},
  ...
  pb: { label: "Paraíba", clubes: [
    ...
    { nome: "Treze", cidade: "Campina Grande, Paraíba", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FTreze.png" },
    { nome: "Spartax", cidade: "João Pessoa, Paraíba", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2FSpartax.png" },
  ]},
  ...
  to: { label: "Tocantins", clubes: [
    { nome: "Next Academy", cidade: "Brasil", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fnext.png" },
  ]},
  ac: { label: "Acre", clubes: [
    { nome: "Next Academy", cidade: "Brasil", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fnext.png" },
  ]},
  ap: { label: "Amapá", clubes: [
    { nome: "Next Academy", cidade: "Brasil", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fnext.png" },
  ]},
  rr: { label: "Roraima", clubes: [
    { nome: "Next Academy", cidade: "Brasil", logo: "https://objectstorage.sa-saopaulo-1.oraclecloud.com/n/grohgpofzbof/b/arquivos-sistema/o/clubes%2Fnext.png" },
  ]},
};
...
const AZUL = "#0C98FC";
  ...
  const PATHS: Record<string, string> = {
    ...
    df: "M 295,247 L 307,247 L 307,257 L 295,257 Z",
  ...
  // Posições das siglas (UF) — centro geométrico real calculado a partir de
  // cada path acima, com tamanho de fonte ajustado para os estados menores
  // (RN, PB, PE, AL, SE, DF, ES, RJ) não vazarem do contorno.
  const LABELS: Record<string, { x: number; y: number; fs: number }> = {
    am: { x: 106.2, y: 113.4, fs: 11.0 },
    pa: { x: 243.1, y: 107.8, fs: 11.0 },
    ro: { x: 129.3, y: 192.7, fs: 11.0 },
    ac: { x: 40.3, y: 178.0, fs: 11.0 },
    rr: { x: 144.0, y: 38.3, fs: 11.0 },
    ap: { x: 257.1, y: 43.4, fs: 11.0 },
    to: { x: 298.1, y: 184.1, fs: 11.0 },
    ma: { x: 334.7, y: 122.5, fs: 11.0 },
    pi: { x: 361.3, y: 151.7, fs: 11.0 },
    ce: { x: 400.6, y: 125.7, fs: 11.0 },
    rn: { x: 434.9, y: 136.2, fs: 7.6 },
    pb: { x: 433.5, y: 151.4, fs: 8.5 },
    pe: { x: 419.8, y: 165.7, fs: 7.7 },
    al: { x: 438.1, y: 182.0, fs: 6.1 },
    se: { x: 425.3, y: 194.4, fs: 7.2 },
    ba: { x: 374.2, y: 213.0, fs: 11.0 },
    mt: { x: 210.5, y: 216.1, fs: 11.0 },
    go: { x: 282.2, y: 254.5, fs: 11.0 },
    ms: { x: 223.3, y: 303.4, fs: 11.0 },
    df: { x: 301.0, y: 252.0, fs: 6.0 },
    mg: { x: 337.6, y: 284.4, fs: 11.0 },
    es: { x: 382.0, y: 299.7, fs: 8.7 },
    rj: { x: 356.9, y: 331.1, fs: 9.1 },
    sp: { x: 290.2, y: 328.7, fs: 11.0 },
    pr: { x: 258.3, y: 356.6, fs: 11.0 },
    sc: { x: 269.8, y: 388.6, fs: 11.0 },
    rs: { x: 239.7, y: 418.0, fs: 11.0 },
  };
        ...
        <div style={{ maxWidth: 620, margin: "0 auto" }}>
          ...
          >
            ...
            >
              ...
              {/* Siglas dos estados — ajuda quem não sabe de cor onde cada UF fica.
                  pointerEvents "none" pra não roubar clique/hover do path por baixo. */}
              {Object.entries(LABELS).map(([id, l]) => (
                <text
                  ...
                  style={{
                    ...
                    fill: "#fff",
                    opacity: id === ativo || id === hover ? 1 : 0.8,
                  }}
                >
                  {id.toUpperCase()}
                </text>
